package com.itranswarp.summer.context.utils;

import com.itranswarp.summer.context.annotation.Bean;
import com.itranswarp.summer.context.annotation.Component;
import com.itranswarp.summer.context.exception.BeanDefinitionException;
...
public class ClassUtils {
    ...
    public static Method findAnnotationMethod(Class<?> clazz, Class<? extends Annotation> annoClass) {
        ...
        List<Method> ms = Arrays.stream(clazz.getMethods()).filter(m -> m.isAnnotationPresent(annoClass)).peek(m -> {
